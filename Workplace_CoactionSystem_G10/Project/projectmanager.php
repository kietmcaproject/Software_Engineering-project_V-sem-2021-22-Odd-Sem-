...
<?php
	...
	$query="select * from employee where Name=(select ReportingManager from employee where Email='$email') and
	ProjectAllocated=(select ProjectAllocated from employee where Email='$email')";
